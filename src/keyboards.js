import { wildcardHostByKey } from './utils.js';

export const K_MAIN = { inline_keyboard:[ [{text:'📱 Menu User', callback_data:'OPEN_CMD|/menu_user'}], [{text:'⚙️ Menu Admin', callback_data:'OPEN_CMD|/menu_admin'}] ] };
...
export function K_wildcard(s, proto, ip, port){
